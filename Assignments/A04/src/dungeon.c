...
void my_Dijkstra_tm(dungeon_t *d)
{
	...
	// on start (ie. init == 0) initialize path[y][x] with their
	// location from [0][0] to [21][80]
	if (!init)
	{
		for (y = 0; y < DUNGEON_Y; y++)
		{ // 21
